...
#include <QMessageBox>
#include <QDebug>
#include "b-tree-movie-search.h"   // Include header for B-Tree implementation (will be created)
#include "hashmap-movie-search.h" // Include header for HashMap implementation (will be created)
